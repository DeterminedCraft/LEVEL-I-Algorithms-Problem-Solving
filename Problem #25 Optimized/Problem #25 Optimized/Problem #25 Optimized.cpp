...
//// the correct solution can be found in Problem 25 file (as opposed to this file which is titled "problem #25 Optimized@
//// Below is some old unoptimized solution:
...
// Insights:
// re-asking the user (in this specific case, to enter a valid age) implies a do..while() statement.
