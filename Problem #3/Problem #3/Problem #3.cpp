...
int ReadPositiveInteger(const string &message) // pass by constant reference.
{
	...
	// NOTE: The above lines are to be sequentially written line by line
...
enEvenOrOdd DetermineEvenOrOdd(const int& number) // pass by constant reference.  // WHENEVER & ALWAYS you see a function of enum user-defined data type.
{                                                                                   // then, it WILL always have:    return enum::EnumerationConstant1 &  return enum::EnumerationConstant2, etc.. in conditional statements.
	if (number % 2 == 0)
	{
...
void PrintEvenOrOdd(const int& number)  // pass by constant reference.
{
	if (DetermineEvenOrOdd(number) == enEvenOrOdd::Even)
	{
		cout << number << " is EVEN \n";
	}
	else
...
int main()
{
	...
	//enEvenOrOdd EvenOrOdd; // the next natural step of declaring a variable of the enum user-defined data type. // commented out as it was later discovered that it's not needed.

	PrintEvenOrOdd(ReadPositiveInteger(" Enter a positive number: ")); // the argument: ReadPositiveInteger() has to be a function. As procedure returns void which can never be the argument of anything as it renders an exception.
	                                                                  // no range argument(s) provided as their value(s) are intrinsic.
	/* I immediately composed the nested functions line above with the concept that DetermineEvenOrOdd() is to be called in the printing procedure.
	   The standard is that, the printing function is to have inside its implementation another called function (in this case: DetermineEvenOrOdd().
	                                               or to have (not applicable in this particular case) inside its implementation, an if statement with a function argument
												   (that returns boolean = of boolean data type off course)
...
/*
  ...
  Extracted from the enumeration mental model (documented in course 3 in this repo): 
  // Mini Mental Model — Enum Return Functions

  // When you see:
  EnumType FunctionName(...)


  // → Then, you'll have:

  return EnumType::Enumerator1;
  return EnumType::Enumerator2;
  return EnumType::EnumeratorN;

  /* EACH in a condition statement: If or Switch.
...
///////////////////////////////////////////////////////////////////////////// Below are previous UNOPTIMIZED SOLUTIONS//////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////// Below are previous UNOPTIMIZED SOLUTIONS//////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////// Below are previous UNOPTIMIZED SOLUTIONS//////////////////////////////////////////////////////////////////////////////
...
//
//	PrintNumberType(CheckNumb(ReadNumber()));
//
//	return 0;
//}
